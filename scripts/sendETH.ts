...
// const deployedMultiSender = '0x2f267b4646cfdB26b18c4571B5c41E8b415Ab9aA' // Deployed MultiSender contract address to Titan Mainnet
...
async function main() {
  ...
  const amounts = [ethers.utils.parseEther('0.0000001'), ethers.utils.parseEther('0.0000002')]
